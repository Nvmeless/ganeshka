...
export const MerchantList = ({...props}) => {
    ...
    const generateShopCards = (shopPram) => {
        ...
        return shopPram[0].map(shop => {
            return <MerchantCard src="./logo192.png" key={shop.name+shop._id} id={shop._id} title={shop.name} description={shop.description} price={shop.horaire} checkpointDistance="200m" favorite={shop.favorite}></MerchantCard>
        })
    }
    return(
